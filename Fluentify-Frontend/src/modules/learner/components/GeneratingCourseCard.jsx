...
const GeneratingCourseCard = ({ state, onClick }) => {
  ...
  return (
    <div
      onClick={onClick}
      className="bg-white/90 dark:bg-slate-900/90 rounded-2xl shadow-xl border border-teal-400/60 overflow-hidden hover:shadow-2xl hover:border-orange-400/70 transition-all cursor-pointer relative"
    >
      {/* Generating Badge */}
      ...
      <div className="p-6">
        ...
        <div className="space-y-2 mb-4">
          <div className="flex justify-between text-xs">
            ...
            <span className="font-semibold text-teal-600 dark:text-teal-300">{progress}</span>
          </div>
        ...
        {/* Stats */}
        <div className="grid grid-cols-3 gap-4 pt-4 border-t border-slate-200 dark:border-white/10 text-xs">
          <div className="text-center">
            <div className="text-lg font-bold text-emerald-600 dark:text-emerald-300">{generatedUnits}</div>
            <div className="text-[11px] text-slate-500 dark:text-slate-300">Generated</div>
          </div>
          <div className="text-center">
            <div className="text-lg font-bold text-teal-600 dark:text-teal-300">
              {totalUnits - generatedUnits}
            </div>
            <div className="text-[11px] text-slate-500 dark:text-slate-300">In Progress</div>
          </div>
          <div className="text-center">
            <div className="text-lg font-bold text-slate-500 dark:text-slate-400">{totalUnits}</div>
            <div className="text-[11px] text-slate-500 dark:text-slate-400">Total Units</div>
          </div>
        </div>
      </div>

      {/* Footer */}
      <div className="bg-slate-50 dark:bg-slate-950/80 border-t border-slate-200 dark:border-white/10 px-6 py-3">
        <div className="text-xs text-teal-700 dark:text-teal-200 font-medium">
          {generatedUnits > 0 ? (
