                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-2 rounded-xl border bg-slate-950/70 text-slate-50 focus:ring-2 focus:ring-amber-400 focus:border-transparent ${
                        errors.start_time ? 'border-rose-500/70' : 'border-white/15'
                      }`}
                    />
                    {errors.start_time && (
                      <p className="text-rose-400 text-xs mt-1">{errors.start_time}</p>
                    )}
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-slate-200 mb-1">
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-2 rounded-xl border bg-slate-950/70 text-slate-50 focus:ring-2 focus:ring-amber-400 focus:border-transparent ${
                        errors.end_time ? 'border-rose-500/70' : 'border-white/15'
                      }`}
                    />
                    {errors.end_time && (
                ...
                <div className="rounded-3xl border border-white/10 bg-slate-950/90 shadow-2xl p-6">
                  ...
                  <div className="space-y-4">
                    {questions.map((q, index) => (
                      <div key={q.id || index} className="border border-white/10 rounded-2xl p-4 bg-slate-900/80">
