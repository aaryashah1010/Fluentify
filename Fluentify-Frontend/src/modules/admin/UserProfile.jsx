  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-teal-50">
      ...
      <main className="max-w-4xl mx-auto px-6 py-10">
        <div className="bg-white rounded-2xl border border-gray-200 shadow-xl p-8 backdrop-blur">
          ...
          <div className="flex items-center gap-6 mb-10 pb-8 border-b border-gray-200">
            <div className="w-24 h-24 rounded-full bg-gradient-to-br from-orange-400 to-teal-400 shadow-lg flex items-center justify-center">
              <User className="w-12 h-12 text-white" />
            </div>
