  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 dark:from-teal-900 via-orange-50 dark:via-orange-900 to-slate-100 dark:to-slate-950 text-slate-900 dark:text-slate-50 relative overflow-x-hidden">
      ...
      <header className="bg-gradient-to-r from-slate-100 dark:from-slate-950/95 via-slate-50 dark:via-slate-900/90 to-slate-100 dark:to-slate-950/95 border-b border-slate-200 dark:border-white/10 shadow-lg backdrop-blur-xl">
        <div className="max-w-4xl mx-auto px-4 py-4 sm:px-6 lg:px-8 flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl md:text-3xl font-bold text-slate-900 dark:text-slate-50">My Profile</h1>
              <p className="text-xs md:text-sm text-slate-600 dark:text-slate-300 mt-1">Manage your admin identity and account details.</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-4 py-8 sm:px-6 lg:px-8 relative z-10">
        <div className="rounded-3xl border border-slate-200 dark:border-white/10 bg-white dark:bg-slate-900/85 shadow-xl hover:shadow-2xl transition-all p-8">
          {/* Success Message */}
          {successMessage && (
          ...
          <div className="flex items-center gap-6 mb-8 pb-8 border-b border-slate-200 dark:border-white/10">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-slate-600 dark:text-slate-300">Platform Administrator</p>
            </div>
          </div>
          ...
          <div className="space-y-6">
              ...
              {isEditing ? (
                <div className="flex gap-2">
                  <Input
                    ...
                    className="flex-1 bg-white dark:bg-slate-900/80 border border-slate-300 dark:border-white/15 text-slate-900 dark:text-slate-50 placeholder-slate-500"
                    error={editError}
                    required
                  />
                  <Button
                ...
                <div className="flex items-center gap-4">
                  <div className="flex-1 bg-white dark:bg-slate-900/80 border border-slate-200 dark:border-white/10 rounded-lg px-4 py-3">
                    <p className="text-slate-900 dark:text-slate-50">{user?.name || 'Not set'}</p>
                  </div>
                  <Button
                    variant="ghost"
                    onClick={() => setIsEditing(true)}
                    icon={<Edit2 className="w-4 h-4" />}
                    className="bg-white dark:bg-slate-900/80 border border-teal-300 dark:border-teal-400/60 text-teal-700 dark:text-teal-100 hover:bg-teal-100 dark:hover:bg-teal-500/20 hover:border-teal-300"
                  >
                    Edit
                  </Button>
                </div>
            ...
            <div>
              ...
              <div className="flex items-center gap-3 bg-white dark:bg-slate-900/80 border border-slate-200 dark:border-white/10 rounded-lg px-4 py-3">
