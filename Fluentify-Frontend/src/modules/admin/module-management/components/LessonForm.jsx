    ...
    <form onSubmit={handleSubmit} className="space-y-4 max-h-[70vh] overflow-y-auto px-1">
      ...
      <div>
        ...
        <input
          ...
          required
          disabled={loading}
          className="w-full px-3 py-2 border border-orange-300 rounded-lg bg-white/70 backdrop-blur-sm focus:ring-2 focus:ring-teal-400 focus:border-transparent"
          placeholder="e.g., Pronouncing Vowels"
        />
      </div>
      ...
      <div>
        ...
        <select
          ...
          required
          disabled={loading}
          className="w-full px-3 py-2 border border-orange-300 rounded-lg bg-white/70 backdrop-blur-sm focus:ring-2 focus:ring-teal-400"
        >
          <option value="">Select Lesson Type</option>
          <option value="pdf">PDF Document</option>
          <option value="video">Video</option>
      ...
      {lessonData.content_type === 'pdf' && (
        <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
          ...
          <input
            ...
            onChange={handleFileChange}
            disabled={loading}
            className="w-full px-3 py-2 border border-orange-300 rounded-lg bg-white/80 backdrop-blur-sm focus:ring-2 focus:ring-teal-400"
          />

          {selectedFile && (
            <div className="mt-2 flex items-center justify-between bg-white/80 backdrop-blur-sm p-2 rounded border border-orange-200">
        ...
        <div className="bg-teal-50 border border-teal-200 rounded-lg p-4 space-y-3">
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              disabled={loading}
              className="w-full px-3 py-2 border border-teal-200 rounded-lg bg-white/80 backdrop-blur-sm focus:ring-2 focus:ring-teal-400"
          ...
          <div>
            ...
            {selectedFile && (
              <div className="mt-2 flex items-center justify-between bg-white/80 backdrop-blur-sm p-2 rounded border border-teal-200">
                <span className="text-sm text-gray-700">{selectedFile.name}</span>
                <button type="button" onClick={removeFile} className="text-red-600 hover:text-red-700">
                  <X className="w-4 h-4" />
                </button>
      ...
      {lessonData.content_type === 'quiz' && (
        <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
          ...
          <p className="text-sm text-gray-600 mb-3">
            Use the exercises section below to create quiz questions.
          </p>
        </div>
      )}
      ...
      {/* XP */}
      <div>
        <label className="block text-sm font-medium text-gray-800 mb-1">XP Reward</label>
        <input
          type="number"
          name="xp_reward"
          value={lessonData.xp_reward || 0}
      ...
      <div>
        ...
        <div className="flex gap-2 mb-2">
          <input
            ...
            onKeyPress={(e) => e.key === 'Enter' && (e.preventDefault(), addKeyPhrase())}
            disabled={loading}
            className="flex-1 px-3 py-2 border border-orange-300 rounded-lg bg-white/70 backdrop-blur-sm focus:ring-2 focus:ring-teal-400"
            placeholder="Add a key phrase"
          />
      ...
      <div>
        ...
        <div className="space-y-1">
          {Object.entries(lessonData.vocabulary || {}).map(([key, value]) => (
            <div
              key={key}
              className="flex items-center justify-between px-3 py-2 bg-white/70 backdrop-blur-sm border border-orange-200 rounded-lg"
            >
              <span className="text-sm">
                <strong>{key}:</strong> {value}
              </span>
      ...
      {/* ACTIONS */}
      <div className="flex gap-3 pt-4 sticky bottom-0 bg-white/80 backdrop-blur-md p-3 border-t border-orange-200">
        <button
          type="button"
          onClick={onCancel}
          disabled={loading}
