  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-900 via-orange-900 to-slate-950 text-slate-50 relative overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        <div
          className="absolute top-16 right-10 text-7xl opacity-10 animate-bounce"
          style={{ animationDuration: '3.4s' }}
        >
          📚
        </div>
        <div
          className="absolute top-40 left-6 text-6xl opacity-10 animate-bounce"
          style={{ animationDuration: '4s', animationDelay: '0.6s' }}
        >
          🌍
        </div>
        <div
          className="absolute bottom-10 left-10 text-6xl opacity-10 animate-bounce"
          style={{ animationDuration: '3.8s', animationDelay: '0.9s' }}
        >
          ✨
        </div>
        <div
          className="absolute bottom-16 right-16 text-7xl opacity-5 animate-bounce"
          style={{ animationDuration: '4.2s', animationDelay: '1.1s' }}
        >
          ✨
        </div>
      </div>
