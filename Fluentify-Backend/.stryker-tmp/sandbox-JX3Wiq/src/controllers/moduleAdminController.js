    ...
    if (stryMutAct_9fa48("1365")) {
      ...
      try {
        if (stryMutAct_9fa48("1366")) {
          ...
          analyticsService.trackAdminModuleUsage(adminId, req.body.language, stryMutAct_9fa48("1367") ? "" : (stryCov_9fa48("1367"), 'CREATE_COURSE'), stryMutAct_9fa48("1368") ? {} : (stryCov_9fa48("1368"), {
            courseId: stryMutAct_9fa48("1369") ? result.data.id : (stryCov_9fa48("1369"), result.data?.id),
            details: stryMutAct_9fa48("1370") ? {} : (stryCov_9fa48("1370"), {
            ...
            if (stryMutAct_9fa48("1371")) {
              ...
              console.warn(stryMutAct_9fa48("1372") ? "" : (stryCov_9fa48("1372"), 'Analytics tracking failed (non-critical):'), analyticsError.message);
            }
          });
        ...
        if (stryMutAct_9fa48("1373")) {
          ...
          stryCov_9fa48("1373");
          console.error(stryMutAct_9fa48("1374") ? "" : (stryCov_9fa48("1374"), 'Error creating course:'), error);
          next(error);
        }
      }
    }
        ...
        if (stryMutAct_9fa48("1385")) {
          ...
          try {
            if (stryMutAct_9fa48("1386")) {
              ...
              stryCov_9fa48("1386");
              await analyticsService.trackAdminModuleUsage(adminId, stryMutAct_9fa48("1389") ? req.body.language && 'Unknown' : stryMutAct_9fa48("1388") ? false : stryMutAct_9fa48("1387") ? true : (stryCov_9fa48("1387", "1388", "1389"), req.body.language || (stryMutAct_9fa48("1390") ? "" : (stryCov_9fa48("1390"), 'Unknown'))), stryMutAct_9fa48("1391") ? "" : (stryCov_9fa48("1391"), 'CREATE_UNIT'), stryMutAct_9fa48("1392") ? {} : (stryCov_9fa48("1392"), {
                courseId: parseInt(courseId),
                unitId: stryMutAct_9fa48("1393") ? result.data.id : (stryCov_9fa48("1393"), result.data?.id),
                details: stryMutAct_9fa48("1394") ? {} : (stryCov_9fa48("1394"), {
                  title: req.body.title,
            ...
            if (stryMutAct_9fa48("1395")) {
              ...
              stryCov_9fa48("1395");
              console.error(stryMutAct_9fa48("1396") ? "" : (stryCov_9fa48("1396"), 'Error tracking admin unit creation analytics:'), analyticsError);
            }
          }
          res.status(201).json(result);
        }
        ...
        if (stryMutAct_9fa48("1405")) {
          ...
          try {
            if (stryMutAct_9fa48("1406")) {
              ...
              stryCov_9fa48("1406");
              await analyticsService.trackAdminModuleUsage(adminId, stryMutAct_9fa48("1409") ? req.body.language && 'Unknown' : stryMutAct_9fa48("1408") ? false : stryMutAct_9fa48("1407") ? true : (stryCov_9fa48("1407", "1408", "1409"), req.body.language || (stryMutAct_9fa48("1410") ? "" : (stryCov_9fa48("1410"), 'Unknown'))), stryMutAct_9fa48("1411") ? "" : (stryCov_9fa48("1411"), 'CREATE_LESSON'), stryMutAct_9fa48("1412") ? {} : (stryCov_9fa48("1412"), {
                unitId: parseInt(unitId),
                lessonId: stryMutAct_9fa48("1413") ? result.data.id : (stryCov_9fa48("1413"), result.data?.id),
                details: stryMutAct_9fa48("1414") ? {} : (stryCov_9fa48("1414"), {
                  title: req.body.title,
            ...
            if (stryMutAct_9fa48("1415")) {
              ...
              stryCov_9fa48("1415");
              console.error(stryMutAct_9fa48("1416") ? "" : (stryCov_9fa48("1416"), 'Error tracking admin lesson creation analytics:'), analyticsError);
            }
          }
          res.status(201).json(result);
        }
